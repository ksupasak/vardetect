 ...
 */
public class ThreadBinaryAlignerLongRead implements Runnable {
    private Thread t;
    ...
    public ThreadBinaryAlignerLongRead(String name,List inSeq, EncodedSequence inEncodeRef,long inchr, int inMer , int inThreshold){
        threadName = name;
        inputSequence = inSeq;
